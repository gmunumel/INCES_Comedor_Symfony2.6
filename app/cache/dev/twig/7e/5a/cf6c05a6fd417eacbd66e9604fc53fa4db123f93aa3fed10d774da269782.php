...
/* INCESComedorBundle:Menu:new.html.twig */
class __TwigTemplate_7e5acf6c05a6fd417eacbd66e9604fc53fa4db123f93aa3fed10d774da269782 extends Twig_Template
{
...
<div id=\"col-text\">
  ...
  <form class=\"menu_form generic\" action=\"";
        // line 7
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "uriForPath", array(0 => "/menu/create"), "method"), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "INCESComedorBundle:Menu:new.html.twig";
    }
