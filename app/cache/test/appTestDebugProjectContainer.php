...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'inces_comedor.profile.form.type' => 'getIncesComedor_Profile_Form_TypeService',
            'inces_comedor.registration.form.type' => 'getIncesComedor_Registration_Form_TypeService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/INCES/ComedorBundle/Entity'))), 'INCES\\ComedorBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('INCESComedorBundle' => 'INCES\\ComedorBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f58cf7fa77a1b24d95e4bf234b1ecc743e0df1c30c97f84c74033f4e5e1fe992');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('INCES\\ComedorBundle\\Entity\\UserAdmin');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('INCES\\ComedorBundle\\Entity\\UserAdmin');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'inces_comedor_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('INCES\\ComedorBundle\\Entity\\UserAdmin');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('INCES\\ComedorBundle\\Entity\\UserAdmin');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'INCES\\ComedorBundle\\Entity\\UserAdmin');
    }
    ...
    /**
     * Gets the 'inces_comedor.profile.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \INCES\ComedorBundle\Form\Type\ProfileFormType A INCES\ComedorBundle\Form\Type\ProfileFormType instance.
     */
    protected function getIncesComedor_Profile_Form_TypeService()
    {
        return $this->services['inces_comedor.profile.form.type'] = new \INCES\ComedorBundle\Form\Type\ProfileFormType('INCES\\ComedorBundle\\Entity\\UserAdmin');
    }

    /**
     * Gets the 'inces_comedor.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \INCES\ComedorBundle\Form\Type\RegistrationFormType A INCES\ComedorBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getIncesComedor_Registration_Form_TypeService()
    {
        return $this->services['inces_comedor.registration.form.type'] = new \INCES\ComedorBundle\Form\Type\RegistrationFormType('INCES\\ComedorBundle\\Entity\\UserAdmin');
    }
    ...
    {
        return $this->services['knp_snappy.pdf'] = new \Knp\Bundle\SnappyBundle\Snappy\LoggableGenerator(new \Knp\Snappy\Pdf(($this->targetDirs[2].'/../web/wkhtmltopdf'), array(), array()), $this->get('monolog.logger.snappy', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['monolog.logger.snappy'] = new \Symfony\Bridge\Monolog\Logger('snappy');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/secured/admin');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/menu/newtoday');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/menu/new');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/menu/facturar');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/menu');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuario/searchtolnc');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/contabilidad/reporteingresostoday');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuario/newexterno');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuario/new');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuario/cargamasiva');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuario/editmasivo');

        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuario/.*/edit');

        $s = new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuario');

        $t = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/list');

        $u = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/register');

        $v = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/profile/edit');

        $w = new \Symfony\Component\HttpFoundation\RequestMatcher('^/contabilidad/reporteingresos');

        $x = new \Symfony\Component\HttpFoundation\RequestMatcher('^/contabilidad/reporteusuarios');

        $y = new \Symfony\Component\HttpFoundation\RequestMatcher('^/contabilidad');

        $z = new \Symfony\Component\HttpFoundation\RequestMatcher('^/rol/new');

        $aa = new \Symfony\Component\HttpFoundation\RequestMatcher('^/rol/.*/edit');

        $ba = new \Symfony\Component\HttpFoundation\RequestMatcher('^/rol');

        $ca = new \Symfony\Component\HttpFoundation\RequestMatcher('^/register');

        $da = new \Symfony\Component\Security\Http\AccessMap();
        $da->add($g, array(0 => 'ROLE_ADMIN'), NULL);
        $da->add($h, array(0 => 'ROLE_OPERADOR', 1 => 'ROLE_GERENTE', 2 => 'ROLE_ADMIN'), NULL);
        $da->add($i, array(0 => 'ROLE_GERENTE', 1 => 'ROLE_ADMIN'), NULL);
        $da->add($j, array(0 => 'ROLE_OPERADOR', 1 => 'ROLE_GERENTE', 2 => 'ROLE_ADMIN'), NULL);
        $da->add($k, array(0 => 'ROLE_GERENTE', 1 => 'ROLE_ADMIN'), NULL);
        $da->add($l, array(0 => 'ROLE_OPERADOR', 1 => 'ROLE_GERENTE', 2 => 'ROLE_ADMIN'), NULL);
        $da->add($m, array(0 => 'ROLE_OPERADOR', 1 => 'ROLE_GERENTE', 2 => 'ROLE_ADMIN'), NULL);
        $da->add($n, array(0 => 'ROLE_OPERADOR', 1 => 'ROLE_GERENTE', 2 => 'ROLE_ADMIN'), NULL);
        $da->add($o, array(0 => 'ROLE_GERENTE', 1 => 'ROLE_ADMIN'), NULL);
        $da->add($p, array(0 => 'ROLE_GERENTE', 1 => 'ROLE_ADMIN'), NULL);
        $da->add($q, array(0 => 'ROLE_GERENTE', 1 => 'ROLE_ADMIN'), NULL);
        $da->add($r, array(0 => 'ROLE_GERENTE', 1 => 'ROLE_ADMIN'), NULL);
        $da->add($s, array(0 => 'ROLE_GERENTE', 1 => 'ROLE_ADMIN'), NULL);
        $da->add($t, array(0 => 'ROLE_ADMIN'), NULL);
        $da->add($u, array(0 => 'ROLE_ADMIN'), NULL);
        $da->add($v, array(0 => 'ROLE_ADMIN'), NULL);
        $da->add($w, array(0 => 'ROLE_ADMIN'), NULL);
        $da->add($x, array(0 => 'ROLE_ADMIN'), NULL);
        $da->add($y, array(0 => 'ROLE_ADMIN'), NULL);
        $da->add($z, array(0 => 'ROLE_ADMIN'), NULL);
        $da->add($aa, array(0 => 'ROLE_ADMIN'), NULL);
        $da->add($ba, array(0 => 'ROLE_ADMIN'), NULL);
        $da->add($ca, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);

        $ea = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $fa = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $ea, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($ea, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/admin/logout'));
        $fa->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $ga = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($ea, array());
        $ga->setOptions(array('login_path' => '/admin/login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $ga->setProviderKey('main');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USUARIO' => array(0 => 'ROLE_USUARIO'), 'ROLE_OPERADOR' => array(0 => 'ROLE_OPERADOR'), 'ROLE_GERENTE' => array(0 => 'ROLE_GERENTE'), 'ROLE_ADMIN' => array(0 => 'ROLE_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USUARIO', 1 => 'ROLE_OPERADOR', 2 => 'ROLE_GERENTE', 3 => 'ROLE_ADMIN', 4 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'/src/INCES/ComedorBundle/Resources/translations/FOSUserBundle.es.yml'), 'es', 'FOSUserBundle');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/INCES/ComedorBundle/Resources/views'), 'INCESComedor');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('dwkKASK!ASKJK!@#KJAKSDJJkkak');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMapping(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/DependencyInjection/Compiler/../../Resources/config/validation/orm.xml'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'INCESComedorBundle' => 'INCES\\ComedorBundle\\INCESComedorBundle',
            ...
            'locale' => 'en',
            'secret' => 'dwkKASK!ASKJK!@#KJAKSDJJkkak',
            ...
            'kernel.secret' => 'dwkKASK!ASKJK!@#KJAKSDJJkkak',
            ...
            'fos_user.model.user.class' => 'INCES\\ComedorBundle\\Entity\\UserAdmin',
            ...
            'fos_user.registration.form.type' => 'inces_comedor_registration',
            ...
            'knp_snappy.pdf.binary' => ($this->targetDirs[2].'/../web/wkhtmltopdf'),
